...
import sg.edu.smu.livelabs.mobicom.views.PrivacyPolicyView;
...
@DaggerScope(PrivacyPolicyPresenter.class)
@Layout(R.layout.privacy_policy_view)
public class PrivacyPolicyPresenter extends ViewPresenter<PrivacyPolicyView> {
    private MainActivity mainActivity;
    private ActionBarOwner actionBarOwner;
    private String url = RestClient.WEBVIEW_BASE_URL + "privacy";
    private boolean error = false;

    public PrivacyPolicyPresenter(MainActivity mainActivity, ActionBarOwner actionBarOwner){
    ...
    protected void onLoad(Bundle savedInstanceState) {
        ...
        actionBarOwner.setConfig(new ActionBarOwner.Config(true, "PRIVACY POLICY", null));
        try {
