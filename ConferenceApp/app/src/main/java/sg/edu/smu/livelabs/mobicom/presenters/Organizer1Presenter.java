...
import sg.edu.smu.livelabs.mobicom.views.Organizer1View;
...
@DaggerScope(Organizer1Presenter.class)
@Layout(R.layout.organizer1_view)
public class Organizer1Presenter extends ViewPresenter<Organizer1View>{
    private String url = RestClient.WEBVIEW_BASE_URL + "organizer";
