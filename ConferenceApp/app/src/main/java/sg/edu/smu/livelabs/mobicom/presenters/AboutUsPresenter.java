...
import sg.edu.smu.livelabs.mobicom.views.AboutUsView;
...
@DaggerScope(AboutUsPresenter.class)
@Layout(R.layout.about_us_view)
public class AboutUsPresenter extends ViewPresenter<AboutUsView> {
    private String url = RestClient.WEBVIEW_BASE_URL + "aboutUs";
