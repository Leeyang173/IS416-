...
import sg.edu.smu.livelabs.mobicom.views.TermView;
...
@DaggerScope(TermPresenter.class)
@Layout(R.layout.term_view)
public class TermPresenter extends ViewPresenter<TermView> {
    private MainActivity mainActivity;
    private ActionBarOwner actionBarOwner;
    private String url = RestClient.WEBVIEW_BASE_URL + "terms";
    private boolean error = false;

    public TermPresenter(MainActivity mainActivity, ActionBarOwner actionBarOwner){
    ...
    protected void onLoad(Bundle savedInstanceState) {
        ...
        actionBarOwner.setConfig(new ActionBarOwner.Config(true, "TERMS & CONDITIONS", null));
        try {
