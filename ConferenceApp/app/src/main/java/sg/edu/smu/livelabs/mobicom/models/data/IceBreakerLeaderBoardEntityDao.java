...
/** 
 * DAO for table "ICE_BREAKER_LEADER_BOARD_ENTITY".
*/
public class IceBreakerLeaderBoardEntityDao extends AbstractDao<IceBreakerLeaderBoardEntity, Long> {

    public static final String TABLENAME = "ICE_BREAKER_LEADER_BOARD_ENTITY";

    /**
     * Properties of entity IceBreakerLeaderBoardEntity.<br/>
    ...
    */
    ...
    public IceBreakerLeaderBoardEntityDao(DaoConfig config) {
        super(config);
    }
    
    public IceBreakerLeaderBoardEntityDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ICE_BREAKER_LEADER_BOARD_ENTITY\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ICE_BREAKER_LEADER_BOARD_ENTITY\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, IceBreakerLeaderBoardEntity entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public IceBreakerLeaderBoardEntity readEntity(Cursor cursor, int offset) {
        IceBreakerLeaderBoardEntity entity = new IceBreakerLeaderBoardEntity( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, IceBreakerLeaderBoardEntity entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(IceBreakerLeaderBoardEntity entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(IceBreakerLeaderBoardEntity entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
