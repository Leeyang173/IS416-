...
import sg.edu.smu.livelabs.mobicom.views.Organizer2View;
...
@DaggerScope(Organizer2Presenter.class)
@Layout(R.layout.organizer2_view)
public class Organizer2Presenter extends ViewPresenter<Organizer2View>{
    private String url = RestClient.WEBVIEW_BASE_URL + "program";
