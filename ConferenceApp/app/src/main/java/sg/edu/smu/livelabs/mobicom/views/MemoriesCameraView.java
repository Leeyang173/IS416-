...
import sg.edu.smu.livelabs.mobicom.presenters.MemoriesCameraPresenter;
import sg.edu.smu.livelabs.mobicom.presenters.screen.MemoriesCameraScreenComponent;

/**
 * Created by smu on 5/11/15.
 */
@AutoInjector(MemoriesCameraPresenter.class)
public class MemoriesCameraView extends LinearLayout implements HandlesBack {
    @Inject
    MemoriesCameraPresenter presenter;
    ...
    public MemoriesCameraView(Context context, AttributeSet attrs) {
        super(context, attrs);
        DaggerService.<MemoriesCameraScreenComponent>getDaggerComponent(context).inject(this);
    }
