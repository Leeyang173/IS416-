...
import sg.edu.smu.livelabs.mobicom.views.TACView;
...
@DaggerScope(TACPresenter.class)
@Layout(R.layout.t_a_c_view)
public class TACPresenter extends ViewPresenter<TACView> {
    public static final String NAME = "TACPresenter";
    private String url = RestClient.WEBVIEW_BASE_URL + "Privacy_agree";
    private ActionBarOwner actionBarOwner;
    private MainActivity mainActivity;
    private boolean error = false;
    private Bus bus;
    public TACPresenter(Bus bus, ActionBarOwner actionBarOwner, MainActivity mainActivity){
    ...
    protected void onLoad(Bundle savedInstanceState) {
        ...
        actionBarOwner.setConfig(new ActionBarOwner.Config(false, "PDPP", null));
        try {
...
//                            getView().agreeBtn.setEnabled(false);
                        }
                    }
                }
