 ...
 */
public abstract class SearchAdapter<T extends SearchItem> extends BaseAdapter
    implements Filterable {

  protected final List<T> items;
  protected final List<T> shallowCopy;
  private final Filter filter = new EvaSearchFilter();

  public SearchAdapter(List<T> items) {
    this.items = items;
   ...
   * @author Leonardo Rossetto
   */
  class EvaSearchFilter extends Filter {
