...
public class SearchView extends FrameLayout implements TextWatcher,
    ...
    protected void init(Context context) {
        ...
        UIHelper.getInstance().setTypeface(wrappedEditText);
    ...
    public interface OnSearchListener {
         ...
         */
        void onSearch(SearchView searchView, CharSequence constraint);
         ...
         * @param constraint the current input data
         */
        void onSearchHint(SearchView searchView, CharSequence constraint);
